...
const PendulumSimulator = () => {
  ...
  return (
    <div className=" w-full h- h-full p-4 text-center bg-white">
      ...
      <div className=" absolute flex items-center justify-center space-x-4 right-16 top-6">
          {/* Botones del pendulo */}
          <div>
            <button
      ...
      {/* sliders del pendulo */}
      <div className=" absolute flex justify-center bg-gray-100 w-1/3 right-16 -mr-10 top-24 -30 text-black">
        <div>
      ...
      <div
          className={`absolute flex flex-row bg-red-500 space-x-2 rounded-lg w-auto h-72 top-2/3 left-96 ${isAnyChartVisible ? "bottom-6" : "-bottom-96"} transition-transform ease-in-out duration-500`}
